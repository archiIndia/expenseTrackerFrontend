  ...
  return (
    <div className={"flex flex-col items-center mt-5"}>
        <div className={"flex flex-col w-1/3 space-y-2 min-w-72"}>
            <label className=" font-bold" htmlFor={"income"}>Income</label>
          <input
              id={"income"}
            type="number"
            value={income_val}
          ...
          />
            <label className=" font-bold" htmlFor={"expense"}>Expense</label>
          ...
          />
            <div className={"grid grid-cols-2 space-x-2 !mt-5"}>
                <button onClick={handleCreateExpense} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Save
                </button>
        ...
        <div className={"flex flex-col w-1/3 m-w-72 space-y-4 mt-4"}>
            {expenses.map((exp,index) => (
                <div key={index} className="flex flex-row  w-full rounded shadow shadow-lg p-6">
